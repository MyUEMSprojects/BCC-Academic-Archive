...
void init() {
    ...
    //         X     Y     Z    Raio   R    G    B
    addSphere( 0.0, -5.0,  0.0, 2.0,  1.0, 0.0, 0.0);
    addSphere( 5.0,  5.0,  5.0, 1.5,  0.0, 1.0, 0.0);
    addSphere(-5.0,  0.0, -5.0, 1.5,  0.0, 0.0, 1.0);
    addSphere( 5.0, -5.0, -5.0, 1.5,  1.0, 1.0, 0.0);

    addSphere(-8.0,  8.0,  8.0, 1.2,  0.0, 1.0, 1.0);
    addSphere( 8.0, -8.0,  2.0, 1.8,  1.0, 0.0, 1.0);
    addSphere( 0.0, 10.0,-10.0, 1.5,  0.5, 0.5, 0.5);
    addSphere(-10.0,-5.0,  5.0, 1.3,  1.0, 0.5, 0.0);

    addSphere( 2.0,  2.0, -2.0, 1.0,  0.2, 0.8, 0.2);
    addSphere(-4.0,  8.0, -2.0, 1.6,  0.5, 0.0, 0.5);
    addSphere( 6.0,  0.0,  8.0, 1.4,  0.0, 0.5, 1.0);
    addSphere(-8.0, -8.0, -8.0, 1.5,  0.8, 0.2, 0.2);
}

// Ray casting - procedimento q projeta dois pontos no espaço 3D
void getRay(int mouseX, int mouseY, Vec3 &origin, Vec3 &direction) {
    ...
    double winY = (double)view[3] - (double)mouseY; // windows - linux
    Vec3 start, end;
    // z = 0(near); z = 1(far)
