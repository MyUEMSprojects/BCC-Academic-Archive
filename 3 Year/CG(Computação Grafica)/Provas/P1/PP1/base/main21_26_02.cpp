...
{
public:
   Line(int x1Val, int y1Val, int x2Val, int y2Val, float r = 0.0, float g = 0.0, float b = 0.0)
   {
...
{
public:
   Rectangle(int x1Val, int y1Val, int x2Val, int y2Val, float r = 0.0, float g = 0.0, float b = 0.0)
   {
      x1 = x1Val; y1 = y1Val; x2 = x2Val; y2 = y2Val;
      red = r; green = g; blue = b;
   }
    ...
    if (button == GLUT_LEFT_BUTTON && state == GLUT_DOWN)
    {
        ...
        else
        {
            ...
            else if (primitive == LINE)
            {
                ...
                {
                    lines.push_back(Line(tempX, tempY, x, y, currentRed, currentGreen, currentBlue));
                    pointCount = 0;
                    isDrawing = false;
                }
            }
            else if (primitive == RECTANGLE)
            {
                ...
                {
                    rectangles.push_back(Rectangle(tempX, tempY, x, y, currentRed, currentGreen, currentBlue));
                    pointCount = 0;
                    isDrawing = false;
                }
            }
