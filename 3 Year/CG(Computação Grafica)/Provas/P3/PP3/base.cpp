...
/* Estenda o algoritmo Sutherland-Hodgeman disponível no site da disciplina, que está limitado a
apenas polígonos convexos, para que considere o recorte de qualquer polígono (inclusive
polígonos côncavos).
*/
